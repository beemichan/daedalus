...
drvAsynSerialPortConfigure("test2_ino","/dev/ttyUSB0")
asynSetOption("test2_ino",0,"baud","9600")
asynSetOption("test2_ino",0,"bits","8")
asynSetOption("test2_ino",0,"parity","none")
asynSetOption("test2_ino",0,"stop","1")
asynSetOption("test2_ino",0,"clocal","Y")
asynSetOption("test2_ino",0,"crtscts","N")
